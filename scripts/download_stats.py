...
repo_full = os.getenv("GITHUB_REPOSITORY", "AliceJump/ok-gm-x-anylabeling-asset")

if "/" in repo_full:
    OWNER, REPO = repo_full.split("/", 1)
else:
    OWNER = "AliceJump"
    REPO = "ok-gm-x-anylabeling-asset"
...
HEADERS = {
    ...
    "User-Agent": "ok-gm-x-anylabeling-asset-download-stats",
}
